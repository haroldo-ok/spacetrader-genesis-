...
void sram_save_full(SAVEGAMETYPE* sg)
{
...
void sram_load_full(SAVEGAMETYPE* sg)
{
    SRAM_enable();
...
uint16_t GEN_FrmDoDialog(FormPtr frm)
{
...
uint16_t GEN_FrmCustomAlert(int alertID, const char* s1, const char* s2, const char* s3)
{
    char body[128];
